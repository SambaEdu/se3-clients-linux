...
# Les fichiers gmd3.
restaurer_via_save "/etc/gdm3/Init/Default"
[ -e "/etc/gdm3/PostLogin/Default" ] && rm -f "/etc/gdm3/PostLogin/Default"
restaurer_via_save "/etc/gdm3/PostSession/Default"
restaurer_via_save "/etc/gdm3/greeter.gconf-defaults"
# Sans la présence explicite de l'option, la fenêtre de connexion
# gdm3 reste dans l'état précédent. C'est pourquoi on va
# explicitement afficher la liste des utilisateurs déjà connectés.
echo "/apps/gdm/simple-greeter/disable_user_list    false" >> "/etc/gdm3/greeter.gconf-defaults"

# Divers
restaurer_via_save "/etc/xdg/user-dirs.defaults"
restaurer_via_save "/usr/share/polkit-1/actions/org.freedesktop.upower.policy"

# Restauration par défaut des daemons exim4 et avahi-daemon.
