...
# On vérifie que le système est bien Trusty.
if [ "$NOM_DE_CODE" != "trusty" ]; then
...
#             "le paramètre 'user-session' devrait" \
...
#    if [ -z "$PARAM_USER_SESSION" ]; then
#        afficher "Désolé, mais le fichier '$LIGHTDM_CONF' n'est pas correct car" \
#                 "le parametre 'user-session' semble vide. Fin du script."
#        exit 1
#    fi
#fi
#unset -v c1 c2
