...
# Le client DHCP.
# Fichier non modifié sous Wheezy
...
#echo "/apps/gdm/simple-greeter/disable_user_list    false" >> "/etc/gdm3/greeter.gsettings"
sed -r -i -e 's/^\disable-user-list=true.*$/disable-user-list=false/g' /etc/gdm3/greeter.gsettings
# Divers
